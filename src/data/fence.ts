...
export const FENCE_PRODUCTS: Record<string, FenceProductData> = {
  'fence-3500x2000x1.1': { key: 'fence-3500x2000x1.1', rentalNo: '01-BAT-GI01-015', saleNo: '0295300', description: 'Girðingar 3,5x2m (1,1kg)', rates: [100, 50, 25, 13, 13, 13, 13, 13, 13, 13, 13, 13], salePrice: 19995, discountPrice: 13900, fenceLength: 3.5 },
  'fence-3500x2000x1.7': { key: 'fence-3500x2000x1.7', rentalNo: '01-BAT-GI01-053', saleNo: '0295317', description: 'Girðingar 3,5x2m (1,7kg)', rates: [100, 50, 25, 13, 13, 13, 13, 13, 13, 13, 13, 13], salePrice: 24995, discountPrice: 17900, fenceLength: 3.5 },
  'fence-3500x1200x1.1': { key: 'fence-3500x1200x1.1', rentalNo: '01-BAT-GI01-052', saleNo: '0295290', description: 'Girðingar 3,5x1,2m', rates: [80, 40, 20, 10, 10, 10, 10, 10, 10, 10, 10, 10], salePrice: 12995, discountPrice: 9900, fenceLength: 3.5 },
  'queue-barrier': { key: 'queue-barrier', rentalNo: '01-BAT-GI01-050', saleNo: '0295292', description: 'Biðraðagirðingar 2,5x1,1m', rates: [130, 65, 33, 16, 16, 16, 16, 16, 16, 16, 16, 16], salePrice: 24995, discountPrice: 17500, fenceLength: 2.5 },
  'plastic-fence': { key: 'plastic-fence', rentalNo: '01-BAT-GI01-043', saleNo: '0295243', description: 'Girðing plast 2,1x1,1m', rates: [80, 40, 20, 10, 10, 10, 10, 10, 10, 10, 10, 10], salePrice: 26995, discountPrice: 21500, fenceLength: 2.1 },
  ...
  'warning-sign': { key: 'warning-sign', rentalNo: '01-BAT-GI01-045', saleNo: '0295245', description: 'Gátaskjöldur 1,3x0,31m', rates: [40, 20, 10, 5, 5, 5, 5, 5, 5, 5, 5, 5], salePrice: 9995, discountPrice: 6900 },
}

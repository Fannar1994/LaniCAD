...
export function LayherSpeedyCalculator() {
  ...
  const getExportData = useCallback(() => ({
    title: 'Layher Speedy Scaf',
    calculatorType: 'Layher Speedy Scaf',
    client,
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="font-condensed text-2xl font-bold text-brand-dark">Layher Speedy Scaf</h1>
      ...
      <div className="rounded-lg border-2 border-dashed border-gray-300 bg-gray-50 p-12 text-center">
        <h2 className="font-condensed text-xl font-semibold text-gray-400">Layher Speedy Scaf</h2>

...
export function ST60Calculator() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="font-condensed text-2xl font-bold text-brand-dark">ST60</h1>
      ...
      <div className="rounded-lg border-2 border-dashed border-gray-300 bg-gray-50 p-12 text-center">
        <h2 className="font-condensed text-xl font-semibold text-gray-400">ST60</h2>
